...
export default function MathBlock({ children, formula, title }: MathBlockProps) {
  // If formula is provided, render KaTeX HTML directly into the main equation container
  if (formula) {
    ...
    return (
      ...
      >
        ...
        {/* Equation body with KaTeX injected directly to match original DOM layout */}
        <div 
          style={{
            padding: '2rem 1.5rem',
            textAlign: 'center',
  ...
  // Fallback mode: render legacy children layout
  return (
    <figure
      aria-label={title ?? 'Mathematical equation'}
      style={{
